...
public:
    ...
    void step() {
        ...
        if (hasReactive) {                          // reactions (gated): see shader pass types
            ...
            for (int t = 3; t <= 87; ++t) {         // + ... petrify, firework, sprout, belt
