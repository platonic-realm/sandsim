/*
 * sandsim - SIMD multi-material engine (AVX2 single-grid)
 *
...
using Ops = AvxOps;
static const char* kImpl = "cpp_materials_avx";
...
static int runInteractive() {
    ...
    SDL_Window* window = SDL_CreateWindow(
        "SIMD Materials (AVX2) - [1]Wall [2]Sand [3]Water [4]Gas [0]Eraser, C clear",
